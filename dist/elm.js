...
{
	if (region.ax.U === region.aJ.U)
	{
		return 'on line ' + region.ax.U;
	}
	return 'on lines ' + region.ax.U + ' through ' + region.aJ.U;
}
...
var $author$project$Test$AdjustTimeZone = function (a) {
	return {$: 13, a: a};
};
	...
	return _Utils_Tuple2(
		{
			...
			M: $elm$time$Time$millisToPosix(0),
			P: $elm$time$Time$utc
		},
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {a0: processes, be: taggers};
	});
...
var $author$project$Test$update = F2(
	function (msg, model) {
			...
			return _Utils_update(
				model,
				{
					...
					z: $elm$core$Maybe$Just(
						$author$project$Test$parseFloat(model.b))
				});
		};
		var calculator = {
			ai: F2(
		...
		var calculate = $elm$core$String$fromFloat(
			A2(
				model.ac,
				A2($elm$core$Maybe$withDefault, 0, model.z),
				$author$project$Test$parseFloat(model.b)));
		...
		switch (msg.$) {
			...
			case 8:
				...
				return model.j ? _Utils_Tuple2(
					...
					_Utils_update(
						...
						{
							j: true,
							b: $elm$core$String$fromInt(number)
						}),
					$elm$core$Platform$Cmd$none);
			case 6:
				return ((!$elm$core$String$isEmpty(model.b)) && model.j) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							b: appendDecimal(model.b)
						}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 1:
				return _Utils_Tuple2(
					operation(calculator.an),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					operation(calculator.aB),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					operation(calculator.as),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
					operation(calculator.ai),
					$elm$core$Platform$Cmd$none);
			case 5:
				return model.j ? _Utils_Tuple2(
					_Utils_update(
			...
			case 13:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			default:
				var changeMode = model.H ? false : true;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{H: changeMode}),
...
var $author$project$Test$Add = {$: 4};
var $author$project$Test$Clear = {$: 9};
var $author$project$Test$DarkMode = {$: 14};
var $author$project$Test$Decimal = {$: 6};
var $author$project$Test$Divide = {$: 1};
var $author$project$Test$Equal = {$: 5};
var $author$project$Test$GenerateRandomNumber = {$: 10};
var $author$project$Test$Minus = {$: 3};
var $author$project$Test$Number = function (a) {
	return {$: 8, a: a};
};
var $author$project$Test$Times = {$: 2};
var $author$project$Test$Zero = {$: 7};
...
var $author$project$Test$clearButton = F2(
...
var $author$project$Test$view = function (model) {
	var themeLabel = model.H ? 'Light Mode' : 'Dark Mode';
	var second = $elm$core$String$fromInt(
		A2($elm$time$Time$toSecond, model.P, model.M));
	var minute = $elm$core$String$fromInt(
		A2($elm$time$Time$toMinute, model.P, model.M));
	var hour = $elm$core$String$fromInt(
		A2($elm$time$Time$toHour, model.P, model.M));
	return A2(
		$elm$html$Html$table,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2($author$project$Test$clearButton, $author$project$Test$Clear, 'Clear')
									]))
							])),
						A2(
						$elm$html$Html$tr,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2(
										$author$project$Test$primaryButton,
										$author$project$Test$Number(7),
										'7')
									])),
								A2(
								$elm$html$Html$td,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2($author$project$Test$primaryButton, $author$project$Test$Zero, '0')
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
...
var $author$project$Test$main = $elm$browser$Browser$element(
	{bF: $author$project$Test$init, b4: $author$project$Test$subscriptions, b8: $author$project$Test$update, b9: $author$project$Test$view});
